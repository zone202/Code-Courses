        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-6">
                <div class="cat-header-text small text-center">
                    <h1 class="fs-5 fw-600">CSS Courses</h1>
                    <p>Learn how to stylize your website with custom CSS. Here we will go over the basics of CSS and how to develop the look and feel of a website.</p>
