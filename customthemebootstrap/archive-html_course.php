        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-6">
                <div class="cat-header-text small text-center">
                    <h1 class="fs-5 fw-600">HTML Courses</h1>
                    <p>Learn the beginning steps to your programming journey with HTML. Here we will go over the basics of HTML and how to develop the "skeleton" of a website.</p>
